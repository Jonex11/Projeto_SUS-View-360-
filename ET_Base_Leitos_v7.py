...
CONFIG = {
    # Diretórios Locais
    "DIRETORIO_BASE": Path("C:/") / "ETL_CNES_LEITOS",
    "DIRETORIO_DOWNLOAD": Path("C:/") / "ETL_CNES_LEITOS" / "downloads",
    "DIRETORIO_EXTRACAO": Path("C:/") / "ETL_CNES_LEITOS" / "extracao",
    "DIRETORIO_SAIDA": Path("C:/") / "ETL_CNES_LEITOS" / "saida",
    "DIRETORIO_LOG": Path("C:/")/ "ETL_CNES_LEITOS" / "logs",
    ...
    "ORACLE_WALLET_PASSWORD": os.getenv("DB_PASS"),
    "ORACLE_DSN_PADRAO": (
